...
class TechBookMetadata {
  ...
  factory TechBookMetadata.fromJson(Map<String, dynamic> json) {
    return TechBookMetadata(
      title: json['title'] as String,
      author: json['author'] as String,
      version: json['version'] as String,
      description: json['description'] as String,
      chapters: (json['chapters'] as List<dynamic>)
          .map((chapter) => TechBookChapter.fromJson(chapter as Map<String, dynamic>))
          .toList(),
...
class TechBookChapter {
  ...
  factory TechBookChapter.fromJson(Map<String, dynamic> json) {
    return TechBookChapter(
      title: json['title'] as String,
      chapterId: json['chapterId'] as String,
      cacheKey: json['cacheKey'] as String,
      description: json['description'] as String?,
      sections: (json['sections'] as List<dynamic>?)
          ?.map((section) => TechBookSection.fromJson(section as Map<String, dynamic>))
          .toList() ?? [],
